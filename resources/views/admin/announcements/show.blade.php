...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="mt-6 flex gap-3">
            <a href="{{ route('admin.announcements.edit', $post) }}" class="bg-yellow-500 text-white px-4 py-2 rounded">Edit</a>
            <a href="{{ route('admin.announcements.index') }}" class="bg-gray-300 px-4 py-2 rounded">Kembali</a>
        </div>
    </div>
@endsection